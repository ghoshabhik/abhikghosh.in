      ...
      description="Professional Experience, technical skills - summary">
        ...
        <div className="mb-5">
          <div className="border border-gray-300 dark:border-gray-700 rounded-lg py-10 px-2 md:px-10 mt-10 lg:text-lg">
            ...
            mb-4 
            text-black dark:text-white">Bio</p>
          ...
          <p className="mb-5 mt-10">I am a Data Solution Architect with over 13 years of experience in software
              engineering. I have
              led
          ...
          <div className="my-5">
            ...
            text-black dark:text-white">Beyond work,</p>
              ...
              <p className="">
                ...
                Hey, If you have come this far, definitely you`&apos;d like to say hello, here is the link for <Link href={'/contact'} passHref><a className="highlighted-link">contact page →</a></Link>. Wish you a great day!
                </p></div>
                </div>
        </div>
      </Container>
