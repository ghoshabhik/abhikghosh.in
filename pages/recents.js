    ...
    <div className="">
      ...
      title="Home for Personal Website/ Developer Portfolio – Abhik Ghosh">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4">
              Here on this page, you can see things like a quick Github dashboard and few other data pulled in to a single page. The songs Abhik is listening to, the books he is reading, the recent posts on Instagrams, and activites on Twitter etc. This is an experimental page to try out various api integrations and curate some meaningful data story. 
        </p>
        </div>
