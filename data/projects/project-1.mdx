...
summary: 'Using RSS to aggregate and simplify how I consume media.here was no shared history  no shared history no shared nd possible'
image: '/static/blog/testeste.jpg'
tags: ['python', 'kafka','leaflet']
