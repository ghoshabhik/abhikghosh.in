        ...
        <div className=" border dark:border-gray-600 border-gray-200 rounded-md px-3 py-2">
           ...
           {data?.map( (tweet, index) => {
                    ...
                    <div key={index} className="flex flex-col justify-between mb-4">
                        <p className="text-black dark:text-gray-100"><a href={tweet.tweet.tweet_url} rel="nofollow noreferrer"  target="_blank">{tweet.tweet.text}</a> - <span className="text-md text-gray-500 dark:text-gray-400">{tweet.tweet.author_name}</span></p>
